...
Source: https://www.nationalparkcam.com/crater-lake-webcam
...
Crater Lake Web c ams

North view across the lake from the Sinnott Overlook at Rim Village (elevation 7,100 ' /2164m). On a clear day, it takes in Wizard Island, Llao Rock, and Mount Thielsen

Annie Spring Entrance looking south along Munson Valley Rd The elevation is 6,000 ' /1,829m (currently off-line)
...
- Image: https://lh3.googleusercontent.com/docsubipk/AP9E6xXL0ohPoDBbOnZs7PtNZcftPTmuhmcaobNulS1d4NXMGWp38IouMBAwLt4k4FjPClSu6667HvGCCfhMfjIYBRTkYMcL2k8snZk5ZUQ642Pv6J89lalgirnhth3STZLoml9TfBHM6WhYkYiJUIuxpUOme_TxU136a1BbFoD5MSxxX0TxBmBUdUY
- Email: https://ssl.gstatic.com/atari/images/sociallinks/email_white_28dp.png

## Embeds

- Custom embed: embedded Google Sites frame (330c945324b99cd3_0); no direct `src` in published HTML
- Custom embed: embedded Google Sites frame (2647855c4e0a1500_33); no direct `src` in published HTML
- Map, Untitled Location: https://maps-api-ssl.google.com/maps?hl=en-US&ll=42.929137,-122.173195&output=embed&q=42.929782,-122.128143+(Untitled+Location)&z=11
- Custom embed: embedded Google Sites frame (2647855c4e0a1500_65); no direct `src` in published HTML
- Custom embed: embedded Google Sites frame (2647855c4e0a1500_73); no direct `src` in published HTML
- Custom embed: embedded Google Sites frame (2647855c4e0a1500_81); no direct `src` in published HTML
